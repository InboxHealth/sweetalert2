...
;(function(window, document) {
  ...
  function closeModal() {
    ...
    // Remove dynamically created media query, IE specific https://github.com/limonte/sweetalert2/commit/e3fdccb006aa96563f7ee0b2df3803d9def30da4
    // Avoid "Failed to execute 'removeChild' on 'Node' error" in Chrome http://stackoverflow.com/questions/21926083/failed-to-execute-removechild-on-node
    var head = document.getElementsByTagName('head')[0];
